...
_PROCESS_WIDGETS: list[dict[str, Any]] = [
    ...
    {"widget_type": "duration_bottleneck_heatmap",
     "title": "Узкие места: топ-10 операций по длительности",
     "tab": "process.duration",
     "config": {"dimension": "department", "activity_level": "raw",
                "sort_by": "duration", "limit": 10},
     "grid_x": 0, "grid_y": 12, "grid_width": 12, "grid_height": 8},
    {"widget_type": "duration_bottleneck_heatmap",
     "title": "Узкие места: топ-10 операций по частоте",
     "tab": "process.duration",
     "config": {"dimension": "department", "activity_level": "raw",
                "sort_by": "frequency", "limit": 10},
     "grid_x": 0, "grid_y": 20, "grid_width": 12, "grid_height": 8},
    {"widget_type": "sojourn_vs_own",
     "title": "Работа и ожидание по операциям",
     "tab": "process.duration",
     "config": {"limit": 15, "activity_level": "raw"},
